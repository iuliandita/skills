...
* **skill-refiner:** refresh harness detection for Antigravity, Command Code, Oh My Pi, Hermes, and OpenCode, with probe-verified headless forms and exact process-name matching ([#206](https://github.com/iuliandita/skills/pull/206), [#199](https://github.com/iuliandita/skills/issues/199)).
