...
- **Pin Trivy to v0.74.0+ for new pins** - v0.69.3 was the March 2026 rollback version, and v0.69.4/5/6 were compromised (CVE-2026-33634). Pin to SHA or image digest.
