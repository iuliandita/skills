...
name: deep-audit
description: >
  Deprecated name. Use repo-audit; load this notice only when deep-audit is explicitly requested.
license: MIT
metadata:
...
Only when the user explicitly invokes the old **deep-audit** name or asks how to migrate it.
