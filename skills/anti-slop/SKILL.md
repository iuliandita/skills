...
Only when the user explicitly invokes the old **anti-slop** name or asks how to migrate it.
...
1. Explain that this skill was renamed or merged into **code-simplification**.
2. If **code-simplification** is installed, offer it by name and use its own instructions when the request authorizes that work.
