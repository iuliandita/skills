...
name: lockpick
description: >
  Deprecated name. Use privilege-escalation; load this notice only when lockpick is explicitly requested.
license: MIT
metadata:
...
Only when the user explicitly invokes the old **lockpick** name or asks how to migrate it.
...
1. Explain that this skill was renamed or merged into **privilege-escalation**.
2. If **privilege-escalation** is installed, offer it by name and use its own instructions when the request authorizes that work.
