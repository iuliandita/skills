...
description: >
  Deprecated name. Use opnsense-pfsense; load this notice only when firewall-appliance is explicitly requested.
license: MIT
metadata:
...
Only when the user explicitly invokes the old **firewall-appliance** name or asks how to migrate it.
...
1. Explain that this skill was renamed or merged into **opnsense-pfsense**.
2. If **opnsense-pfsense** is installed, offer it by name and use its own instructions when the request authorizes that work.
