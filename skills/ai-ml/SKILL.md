...
name: ai-ml
description: >
  Deprecated name. Use llm-app-development; load this notice only when ai-ml is explicitly requested.
license: MIT
metadata:
...
Only when the user explicitly invokes the old **ai-ml** name or asks how to migrate it.
...
1. Explain that this skill was renamed or merged into **llm-app-development**.
2. If **llm-app-development** is installed, offer it by name and use its own instructions when the request authorizes that work.
