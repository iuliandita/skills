...
| mcp | `.mcp.json`, `mcp.json` | `@modelcontextprotocol/sdk`, `@modelcontextprotocol/server`, `@modelcontextprotocol/client`, `@modelcontextprotocol/core`, `fastmcp`, Python `mcp` (anchored to dependency syntax - version specifiers, extras brackets, or quotes - not any substring match) |
