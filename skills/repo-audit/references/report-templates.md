...
```markdown
# Exhaustive Repo Audit - {repo_name}
...
## Wave 4 - Security
{security-audit + vulnerability-research sections, native format preserved}
{reference the dated `docs/local/audits/security-audit/<YYYY-MM-DD>-<slug>.md` location instead of duplicating full content}
