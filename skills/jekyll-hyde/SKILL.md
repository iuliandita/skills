...
name: jekyll-hyde
description: >
  Deprecated name. Use plan-review; load this notice only when jekyll-hyde is explicitly requested.
license: MIT
metadata:
...
Only when the user explicitly invokes the old **jekyll-hyde** name or asks how to migrate it.
