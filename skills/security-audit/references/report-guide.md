...
- trivy: `brew install trivy` or see https://aquasecurity.github.io/trivy (use v0.74.0+ from official releases; v0.69.3 was the March 2026 incident rollback; never use v0.69.4-0.69.6)
