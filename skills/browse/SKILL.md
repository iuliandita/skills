...
name: browse
description: >
  Deprecated and removed. Load this notice only when browse is explicitly requested; no replacement skill.
license: MIT
metadata:
...
Only when the user explicitly invokes the old **browse** name or asks how to migrate it.
