...
name: zero-day
description: >
  Deprecated name. Use vulnerability-research; load this notice only when zero-day is explicitly requested.
license: MIT
metadata:
...
Only when the user explicitly invokes the old **zero-day** name or asks how to migrate it.
...
1. Explain that this skill was renamed or merged into **vulnerability-research**.
2. If **vulnerability-research** is installed, offer it by name and use its own instructions when the request authorizes that work.
