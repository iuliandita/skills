...
name: full-review
description: >
  Deprecated name. Use repo-audit; load this notice only when full-review is explicitly requested.
license: MIT
metadata:
...
Only when the user explicitly invokes the old **full-review** name or asks how to migrate it.
...
1. Explain that this skill was renamed or merged into **repo-audit**.
2. If **repo-audit** is installed, offer it by name and use its own instructions when the request authorizes that work.
