...
name: localize
description: >
  Deprecated name. Use i18n-localization; load this notice only when localize is explicitly requested.
license: MIT
metadata:
...
Only when the user explicitly invokes the old **localize** name or asks how to migrate it.
...
1. Explain that this skill was renamed or merged into **i18n-localization**.
2. If **i18n-localization** is installed, offer it by name and use its own instructions when the request authorizes that work.
