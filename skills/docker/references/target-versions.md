...
September 2026 snapshot. Verified 2026-09-03 against Docker release notes, Docker Desktop releases,
and upstream GitHub release APIs. Verify current releases before pinning.

- Docker Engine 29.7.2, Docker Desktop 4.86.0 (same version across Windows, macOS, Linux)
- Docker Compose v5.5.1 (Go SDK, Bake-delegated builds)
- BuildKit v0.33.0 (Docker Engine 29.7.2 bundles 0.32.2)
